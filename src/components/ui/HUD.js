...
export const HUD = ({ playerStats, getTotalDefense }) => (
  <div style={{
    ...
    <div style={{ marginBottom: '8px' }}>
      ...
      <div style={{ width: '100%', height: '12px', background: '#1f2937', borderRadius: '6px', overflow: 'hidden', border: '1px solid #374151' }}>
        <div style={{ width: `${(playerStats.hp / playerStats.maxHp) * 100}%`, height: '100%', background: 'linear-gradient(90deg, #ef4444, #dc2626)', transition: 'width 0.3s' }} />
      </div>
    </div>
    ...
    <div style={{ marginBottom: '8px' }}>
      ...
      <div style={{ width: '100%', height: '12px', background: '#1f2937', borderRadius: '6px', overflow: 'hidden', border: '1px solid #374151' }}>
        <div style={{ width: `${(playerStats.xp / playerStats.maxXp) * 100}%`, height: '100%', background: 'linear-gradient(90deg, #f59e0b, #d97706)', transition: 'width 0.3s' }} />
      </div>
    </div>
